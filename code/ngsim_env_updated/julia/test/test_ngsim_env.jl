...
function test_basics()
    ...
    env = NGSIMEnv(params)
    println("ENV SUCCESSFULLY CREATED")
    # reset, step
    x = reset(env)
    println("ENV SUCCESSFULLY RESET")
    a = [0., 0.]
