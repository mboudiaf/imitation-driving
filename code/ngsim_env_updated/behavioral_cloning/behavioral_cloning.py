...
def main():
    ...
    parser.add_argument('--data_dir',           type=str,
                        default='~/gail-driver/julia/2d_drive_data/', help='directory containing data')
    ...
    parser.add_argument('--state_dim',          type=int,
                        default=64,       help='number of state variables')
    ...
    parser.add_argument('--mlp_size',           type=int, nargs='+',
                        default=[128,64,64],        help='number of neurons in each feedforward layer')
    parser.add_argument('--gru_input_dim',      type=int,
                        default=0,        help='size of input to gru layer')
    ...
    with tf.Session() as sess:
        ...
        def val_loss():
            ...
            for b in range(data_loader.n_batches_val):
                ...
                feed_in = {}
                feed_in[net.inputs] = s#s_t
                feed_in[net.targets] = a#a_t
                if args.gru_input_dim > 0:
        ...
        for e in range(args.num_epochs):
            ...
            for b in range(data_loader.n_batches_train):
                ...
                if (e * data_loader.n_batches_train + b) % 10 == 0 and b > 0:
                    print("{}/{} (epoch {}), train_loss = {:.3f}, time/batch = {:.3f}".format(e * data_loader.n_batches_train + b,args.num_epochs * data_loader.n_batches_train,e, loss / 10. / args.batch_size, end - start))
                    loss = 0.0
