...
NGSIM_FILENAME_TO_ID = {
    'trajdata_lankershim_trajectories.txt':1,
   # 'trajdata_i101_trajectories-0750am-0805am.txt': 2,
...
def load_trajs_labels(directory, files_to_use=[0]):
    filenames = [
        'trajdata_lankershim_trajectories_trajectories.npz',
       ...
       # 'trajdata_lankershim_trajectories.npz'
    ]
